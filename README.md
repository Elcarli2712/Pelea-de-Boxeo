El proyecto consiste en un planificador de eventos ,desarrollado en python, en el cual se asignarán una fecha determinada y los recursos (en cantidades limitadas) para gestionar combates de boxeo. Su objetivo consiste en permitir al usuario añadir,listar y eliminar eventos, respetando una cierta lógica diseñada por el creador.
...
# Estructura:
Todo se halla estructurado en el archivo proyecto.py, donde están ubicadas todas las clases y funciones que dan vida al proyecto
